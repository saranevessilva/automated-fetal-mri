    ...
    for group in groups:
        ...
        for imgNum in range(0, dset.number_of_images(group)):
            ...
            if ((mrdImg.data.shape[0] == 3) and (mrdImg.getHead().image_type == 6)):
                ...
                position = mrdImg.position[0], mrdImg.position[1], mrdImg.position[2]
                orientation = (mrdImg.read_dir[0], mrdImg.read_dir[1], mrdImg.read_dir[2],
                               mrdImg.phase_dir[0], mrdImg.phase_dir[1], mrdImg.phase_dir[2],
                               mrdImg.slice_dir[0], mrdImg.slice_dir[1], mrdImg.slice_dir[2])
