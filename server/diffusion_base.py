...
def Diff_analysis(data_diff, images, connection, config, metadata, oldHeader):
    ...
    print(case_path + "/brain_PP")
    df_sorted, file_path = process_data(case_path + "/nnUNet_images/", case_path + "/brain_PP/", "/home/sn21/RT_diffusion/diffusion.txt",  case_path + "/analysis_diffusion.xlsx")
    ...
    create_priority_list(repeat_dyn, "/home/sn21/RT_diffusion/diffusion.txt", case_path + "/diffusion_reacquisition.dvs")
