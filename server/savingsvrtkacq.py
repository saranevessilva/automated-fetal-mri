...
def process_image(images, connection, config, metadata):
    ...
    input_folder = f"/home/sn21/data/t2-stacks/{today_date}"
    output_folder = f"/home/sn21/data/t2-stacks/{today_date}/{current_time}/dicoms"
    ...
    bash_command = f"cd {input_folder} && python /home/sn21/python-ismrmrd-server/mrd2dicom.py . -o {output_folder}"
